...
> 本文档继承自上游 [ultraworkers/claw-code](https://github.com/ultraworkers/claw-code)（MIT License），经本仓库适配修改。
...
- `code-developer` token has write access to push branches to `ultraworkers/claw-code` but lacks `createPullRequest` permission (GraphQL 404)
