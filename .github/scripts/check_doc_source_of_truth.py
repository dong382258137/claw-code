...
FORBIDDEN = {
    r'github\.com/Yeachan-Heo/claw-code(?!-parity)': 'replace old claw-code GitHub links with dong382258137/claw-code',
    r'github\.com/code-yeongyu/claw-code': 'replace stale alternate claw-code GitHub links with dong382258137/claw-code',
    r'discord\.gg/6ztZB9jvWq': 'replace the stale UltraWorkers Discord invite with the current invite',
    r'api\.star-history\.com/svg\?repos=Yeachan-Heo/claw-code': 'update star-history embeds to dong382258137/claw-code',
    r'star-history\.com/#Yeachan-Heo/claw-code': 'update star-history links to dong382258137/claw-code',
